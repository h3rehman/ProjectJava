        ...
        if (action.equals("lookup") && !searchId.equals("")) {
            ...
            try {
                ...
                for (Map.Entry<String, Product> entry : productHM.entrySet()) {
                    ...
                    //pw.print("<img src='images/" + products.getCategory() + "/" + products.getImage() + "' alt='...'>");  //insert images in DB
                    ...
                    pw.print("<input type='hidden' name='type' value='" + products.getCategory() + "'>");
                    pw.print("<input type='hidden' name='maker' value='" + products.getManufacturer() + "'>");
                    pw.print("<input type='hidden' name='access' value=''>");
                    pw.print("<button type='submit' class='btnbuy' value='Buy Now'>Buy Now</input>");
                    pw.print("</form></br>");
