...
public class LaptopsList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		/* Checks the Tablets type whether it is HP, DELL or Apple */
		...
		pw.print("</h2><div class='entry'><table id='featured'>"); 
		...
		for(Map.Entry<String, Laptop> entry : hm.entrySet())
		{
			...
			pw.print("<li id='item'><img src='images/laptops/"+laptop.getImage()+"' alt='Laptops' /></li>");
